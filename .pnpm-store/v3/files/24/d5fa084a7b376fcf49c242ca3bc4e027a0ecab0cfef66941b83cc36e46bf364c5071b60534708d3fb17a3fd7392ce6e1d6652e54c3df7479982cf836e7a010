...
export { AsPlainObject, AutoVacuumOptions, BM25Params, MatchInfo, Options, Query, QueryCombination, SearchOptions, SearchResult, Suggestion, VacuumConditions, VacuumOptions, MiniSearch as default };
